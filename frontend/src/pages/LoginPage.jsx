...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-black text-white">
      {/* Main content */}
      <div className="flex-grow flex flex-wrap items-center justify-center w-full flex-col lg:flex-row">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 py-4 w-full">
        <p className="text-center text-gray-400 text-sm">
          &copy; 2021 All rights reserved <br /> 
          For Testing Purposes: Username: <strong>test1</strong> , Password: <strong>test@01</strong>
        </p>
      </footer>
    </div>
  );
